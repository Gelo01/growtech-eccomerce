    ...
    <div>
        <section className="text-gray-600 body-font flex  items-center justify-center">
                ...
                <div className="container px-10 flex py-5 flex-col lg:flex-row">
                    ...
                    <img 
                    className="m-auto lg:w-2/6 md:w-3/6 w-5/6 object-cover object-center rounded-3xl" alt="hero" 
                    src="./images/mid-picture.png"
                    />
                    <div className="text-center lg:w-3/3 w-full md:text-justify px-5">
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 py-5 font-bold text-gray-900 lg:text-center">Urban Planning Globally</h1>
