...
const Header = ( fixed ) => {
    ...
    return (
        ...
        <div className="container px-2 mx-auto flex flex-wrap items-center justify-between">
          ...
          >
            <ul className="text-grey-600 flex flex-col lg:flex-row list-none lg:ml-auto text-center">

              <li className="no-underline	cursor-pointer nav-item px-3 flex items-center text-xs uppercase font-bold leading-snug  hover:opacity-75">
              <Link to="/" className="text-decoration-none text-dark ml-2">
              Our Products
              </Link>
              </li>
              <li className="cursor-pointer nav-item px-3 flex items-center text-xs uppercase font-bold leading-snug  hover:opacity-75">
              <Link to="/about_us" className="text-decoration-none text-dark ml-2">
              About
              </Link>
              </li>  
              <li className="cursor-pointer nav-item px-3 flex items-center text-xs uppercase font-bold leading-snug  hover:opacity-75">
              <Link to="/services" className="text-decoration-none text-dark ml-2">
              Services
              </Link>
              </li>  
              <li className="cursor-pointer nav-item px-3 flex items-center text-xs uppercase font-bold leading-snug  hover:opacity-75">
              <Link to="/features" className="text-decoration-none text-dark ml-2">
              Features
              </Link>
              </li>  
              <li className="cursor-pointer nav-item px-3 flex items-center text-xs uppercase font-bold leading-snug  hover:opacity-75">
              <Link to="/contact" className="text-decoration-none text-dark ml-2">
              Contact Us
              </Link>
              </li>  
              <li className="cursor-pointer nav-item px-3 flex items-center text-xs uppercase font-bold leading-snug  hover:opacity-75">
              <Link to="/blogs" className="text-decoration-none text-dark ml-2">
              Blogs
              </Link>
              </li>  
            </ul>
