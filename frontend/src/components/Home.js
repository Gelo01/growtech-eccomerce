      ...
      {loading? <Loader/>: (
        <Fragment>
            ...
            <div className="flex justify-center py-10 text-gray-600">
                    ...
                    <h1 className="text-3xl text-grey-600 text-center font-bold mx-6 md:text-6xl md:pt-0">OUR PRODUCTS</h1>
                    <span className="inline-block h-1 w-20 rounded bg-green-500 mt-6 mb-4 md:w-40"></span>
                </div>
            
      <section id="products" className="container mt-3">
      <div className="col-12 mt-2 mt-md-0 flex justify-center">
